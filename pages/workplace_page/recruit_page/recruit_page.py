...
class Recruit(BasePage):
    ...
    def report(self,number):
        ...
        time.sleep(1)
        self.input(self.select_text,r'D:\auto_test\script\正常报备测试数据{0}条.xlsx'.format(number))
        print('上传文件')
        time.sleep(1)
        self.click(self.next_button)
        print("下一步")
    ...
    def abnormal_report(self,number):
        ...
        # time.sleep(1)
        self.input(self.select_text, r'D:\auto_test\script\异常报备测试数据{0}条.xlsx'.format(number))
        print('上传文件')
        time.sleep(1)
        self.click(self.next_button)
        print("下一步")
